...
- **Exploitation & access:** gaining initial access and establishing a reverse shell
...
**Skills:** Ghidra · x64dbg · GDB · static & dynamic analysis · anti-reversing concepts
...
**Skills:** Linux administration · permissions & access control · filesystems · shell & regex

---

## Cloud-Native Security — Hardened Infrastructure
...
- **Containers & orchestration:** Docker (non-root user) and **Kubernetes** — replicas for HA, Secrets, ConfigMaps, network policies, least-privilege service accounts
...
## Social Engineering — Simulated Campaign & Defense
...
**Skills:** OSINT · phishing/pretexting awareness · human risk analysis · security awareness & defense
...
to Cybersecurity, Cryptography, Computer Architecture & Operating Systems, Networking
(routing & switching, network services), and programming in Python and Java.
